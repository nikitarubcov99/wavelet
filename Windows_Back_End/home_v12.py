...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action_7.triggered.connect(self.add_data_for_II)  # вызов действия по вкладку в menu
        self.action_8.triggered.connect(self.add_type_porog_photo)  # вызов действия по вкладку в menu
    ...
    """_______________________Открытие окна "Работа с ИИ"_________________________"""
    ...
    """____________________Открытие окна "Добавление порогов"_____________________"""
    ...
    def long_signal(self):
        ...
        try:
            ...
            if index_znach == '':
                ...
                msg.setIcon(QMessageBox.Critical)
                msg.setText("Ошибка")
                msg.setInformativeText('Не выбран КОМПОНЕНТ edf файла!')
                msg.setWindowTitle("Error")
                msg.exec_()
                ...
                self.label_44.setText(f'Минимальная и Максимальная длинна сигнала:  (0, {A_length})')
                self.label_32.setText(f'Входной сигнал на отрезке:           ( {sig_1}  :  {sig_2} )')
                ...
                for i in hr[0]:
                    hr_.append(i)
                # print("сердцебиение:", hr_)

                styles = {'color': 'r', 'font-size': '12px'}

                self.widget_11.clear()
                self.widget_11.setLabel('left', 'ЧСС (кол-во)', **styles)
                self.widget_11.setLabel('bottom', 'Время (с)', **styles)
    ...
    def otk_norm(self):
        ...
        try:
            ...
            if cursor.fetchone() is None:
                ...
                msg.setIcon(QMessageBox.Critical)
                msg.setText("Ошибка")
                msg.setInformativeText('НОРМА не выбрана. БД не подключено!')
                msg.setWindowTitle("Error")
                msg.exec_()
    ...
    def add_to_database_new_data(self):
        ...
        try:
            ...
            if cursor.fetchone() is None:
                ...
                msg.setIcon(QMessageBox.Critical)
                msg.setText("Ошибка")
                msg.setInformativeText('SNILS не найден. БД не подключено!')
                msg.setWindowTitle("Error")
                msg.exec_()
    ...
    def customer_names_for_II(self):
        ...
        if names__ == '':
            ...
            msg.setIcon(QMessageBox.Information)
            msg.setText("ERROr")
            msg.setInformativeText('Пациент не указан!')
            msg.setWindowTitle("=(")
            msg.exec_()
        else:
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_13.setText(_translate("MainWindow", "Статистическое среднее:"))
        ...
        self.label_6.setText(_translate("MainWindow", "Частота сердцебиения:"))
        self.label_40.setText(_translate("MainWindow", "-"))
        self.label_41.setText(_translate("MainWindow", "Прогнозируемая оценка для Врача: "))
        self.pushButton_13.setText(_translate("MainWindow", "Использовать ИИ"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_5), _translate("MainWindow", "PQRST"))
        self.label_32.setText(_translate("MainWindow", "Входной сигнал на отрезке: "))
        ...
        self.label_42.setText(_translate("MainWindow", "Работа с СИГНАЛОМ edf"))
        ...
        self.label_2.setText(_translate("MainWindow", "Длина сигнала:"))
        self.label_3.setText(_translate("MainWindow", ":"))
        self.pushButton_3.setText(_translate("MainWindow", "+"))
        self.label_43.setText(_translate("MainWindow", "ИНФОРМАЦИЯ:"))
        self.label_4.setText(_translate("MainWindow", "Компонент:"))
        self.label_44.setText(_translate("MainWindow", "Минимальная и Максимальная длинна сигнала:"))
        ...
        self.action_8.setText(_translate("MainWindow", "Добавить тип порога для изображения"))
from pyqtgraph import PlotWidget
