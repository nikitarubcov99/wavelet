...
# Form implementation generated from reading ui file 'Windows_Front_End\add_type_porog_photo.ui'
#
...
class Ui_Porog_Photo(object):
    def setupUi(self, Form):
        ...
        Form.resize(344, 308)
        Form.setMinimumSize(QtCore.QSize(344, 308))
        Form.setMaximumSize(QtCore.QSize(344, 308))
        self.pushButton = QtWidgets.QPushButton(Form)
        self.pushButton.setGeometry(QtCore.QRect(130, 260, 81, 23))
        ...
        self.label_6.setGeometry(QtCore.QRect(30, 230, 291, 21))
        self.label_6.setStyleSheet("color: rgb(128, 128, 128);")
        self.label_6.setObjectName("label_6")
        self.layoutWidget = QtWidgets.QWidget(Form)
        self.layoutWidget.setGeometry(QtCore.QRect(30, 120, 293, 106))
    ...
    def add_type_porog_photo(self):
        ...
        if len(name) == 0:
            ...
            msg.setIcon(QMessageBox.Information)  # восклицательный
            msg.setText("ERROR!")
            msg.setInformativeText('Ошибка ПОРОГ 1!')
            msg.setWindowTitle("Add")
            msg.exec_()
            ...
            msg.setIcon(QMessageBox.Information)  # восклицательный
            msg.setText("ERROR!")
            msg.setInformativeText('Ошибка ПОРОГ 2!')
            msg.setWindowTitle("Add")
            msg.exec_()
            ...
            msg.setIcon(QMessageBox.Information)  # восклицательный
            msg.setText("ERROR!")
            msg.setInformativeText('Ошибка ПОРОГ 3!')
            msg.setWindowTitle("Add")
            msg.exec_()
...
"ТИПА ИЗОЗОБРАЖЕНИЯ:"))
        self.label_6.setText(_translate("Form", "Максимальное значение: (127, 127, 127)"))
